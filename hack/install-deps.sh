...
sudo rpm -ivh --nodeps \
  "${FEDORA_BASE}/l/libbtrfs-${BTRFS_VERSION}.x86_64.rpm" \
  "${FEDORA_BASE}/l/libbtrfsutil-${BTRFS_VERSION}.x86_64.rpm" 2>/dev/null || echo "Libraries may already be installed"

# Now install devel package with --nodeps
sudo rpm -ivh --nodeps \
  "${FEDORA_BASE}/b/btrfs-progs-${BTRFS_VERSION}.x86_64.rpm" 2>/dev/null || echo "btrfs-progs may already be installed"

sudo rpm -ivh --nodeps \
  "${FEDORA_BASE}/b/btrfs-progs-devel-${BTRFS_VERSION}.x86_64.rpm"
